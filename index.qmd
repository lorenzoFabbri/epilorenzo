...
Alongside my research, I am pursuing further graduate training in public health (LSHTM and UNED), theoretical statistics (the Open University), and economics (UOC). I also build open-source tools for reproducible research: I lead the [etverse](https://etverse.github.io/) ecosystem for transparent causal inference and maintain the CRAN packages [forrest](https://cran.r-project.org/package=forrest) and [orcidtr](https://cran.r-project.org/package=orcidtr). Originally from San Marino 🇸🇲 and currently based in Spain 🇪🇸.
